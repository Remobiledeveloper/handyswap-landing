    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 container pt-24 pb-16 lg:pt-28 lg:pb-20">
          <div className="flex flex-col lg:flex-row lg:items-center lg:gap-12 xl:gap-16 gap-10">
            ...
            <div className="lg:w-[45%] lg:flex-shrink-0 flex flex-col gap-5 text-center lg:text-left">
              ...
              {/* Guarantee */}
              <p className="text-sm sm:text-base font-semibold text-emerald-300 tracking-wide flex items-center gap-2 justify-center lg:justify-start">
            ...
            <div className="flex-1 flex flex-col items-center lg:items-end">
              ...
              <div className="relative flex items-center justify-center gap-4 sm:gap-8 mb-[-2rem]">
                ...
                <div className="w-48 sm:w-56 lg:w-64 transform rotate-3 hover:rotate-0 transition-transform duration-700">
                  <img
                    src={IPHONE_IMG}
      ...
      {/* ========== FOOTER ========== */}
      <footer className="bg-[#0a1628] pt-12 pb-20 sm:pb-14">
        <div className="container">
          ...
          <div className="mb-8 pb-8 border-b border-white/10">
            <div className="flex items-center justify-center gap-5">
              <a
                ...
                aria-label="Facebook"
              >
                <svg className="w-5 h-5 text-white/40 group-hover:text-[#1877F2] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              >
                <svg className="w-5 h-5 text-white/40 group-hover:text-[#E4405F] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                aria-label="YouTube"
              >
                <svg className="w-5 h-5 text-white/40 group-hover:text-[#FF0000] transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group w-11 h-11 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/15 hover:border-white/30 transition-all duration-300"
                aria-label="TikTok"
              >
